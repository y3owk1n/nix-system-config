      ...
      plugins = [
        ...
        }
        {
          ...
          src = pkgs.fetchFromGitHub {
            owner = "y3owk1n";
            repo = "fish-fzf";
            rev = "04098610b8abfab5ea4edc07b79d0c618a20c655";
            sha256 = "sha256-6fVZwOhu0fzIiMgZSP5hHbmFJZE00lOc9KM66m453S8=";
          };
        }
        {
          name = "fish-x";
          src = pkgs.fetchFromGitHub {
            owner = "y3owk1n";
            repo = "fish-x";
            rev = "c87b6b4a4bbcef1ecabb02d0442b74d7a6b35e02";
            sha256 = "sha256-w8QJ1TAQT9xTuqPpwBht9RXUYVoMr6zE5bC4t6Pxylw=";
          };
        }
      ];
      functions = {
